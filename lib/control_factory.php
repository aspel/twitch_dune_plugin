...
class ControlFactory
{
    ...
    public static function add_button(&$defs,
        $handler, $add_params,
        $name, $title, $caption, $width, $centered=false)
    {
        $push_action =
    ...
    public static function add_custom_button(&$defs,
        $name, $title, $caption, $width, $action, $centered=true)
    {
        $defs[] = array
        (
            GuiControlDef::name => $name,
    ...
    public static function add_close_dialog_and_apply_button(&$defs,
        $handler, $add_params,
        $name, $caption, $width, $centered=false)
    {
    ...
    public static function add_custom_close_dialog_and_apply_button(&$defs,
        $name, $caption, $width, $action, $centered=false)
    {
        $defs[] = array
        (
            GuiControlDef::name => $name,
